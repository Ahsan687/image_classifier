...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        # image_dir = directory for pet images
        # key = the filename
        
        
        # print(model_label)
      
        match_nomatch = results_dic[key][0]
        if match_nomatch in model_label:
            # Model_label = classifier will be given index 1 and added to list of results_dic
